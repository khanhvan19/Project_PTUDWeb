...
<template>
    <div>
        <div class="d-flex justify-content-between align-items-center">
            <h5 class="fw-bold my-3">Quản lý Tour</h5>
            <div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="modal-title fs-5 fw-bold">Chỉnh sửa Tour</div>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form>
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="tour" class="form-label fw-semibold">Tên Tour</label>
                                <input 
                                    required
                                    type="text" id="tour"
                                    class="form-control" 
                            ...
                            <div class="mb-3">
                                <label for="price" class="form-label fw-semibold">Giá Tour</label>
                                <input 
                                    required
                            ...
                            <div class="mb-3">
                                <label for="num-cus" class="form-label fw-semibold">Số lượng khách</label>
                                <input 
                                    required
                                    type="number" 
                                    id="num-cus" min="1"
                            ...
                            <div class="mb-3">
                                <div class="d-flex">
                                    <div class="d-flex me-3 align-items-center justify-content-between flex-fill">
                                        <label for="day" class="form-label fw-semibold text-nowrap mb-0">Số ngày: </label>
                                        <input 
                                            required
                                    ...
                                    <div class="d-flex ms-3 align-items-center justify-content-between flex-fill">
                                        <label for="night" class="form-label fw-semibold text-nowrap mb-0">Số đêm: </label>
                                        <input 
                                            required
                            ...
                            <div class="mb-3">
                                <label for="info" class="form-label fw-semibold">Mô tả</label>
                                <textarea 
                                    required
                                    class="form-control" id="info" rows="3"
