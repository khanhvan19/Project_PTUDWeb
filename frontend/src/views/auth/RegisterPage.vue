...
<template>
    <div class="wrapper">
        <img src="@/assets/images/banner/da-nang.jpg">
    </div>
    <form @submit.prevent="onSubmit(this.data)" class="register-form px-5 py-4 rounded-4">
        ...
        <div class="mb-4">
            ...
            <button type="submit" class="btn btn-lg btn-success w-100">Đăng Ký</button>
        </div>
        <div class="text-center text-white">
            <span class="fst-italic fw-light me-2">Bạn đã có tài khoản?</span>
            <router-link to="/login" class="fw-bolder">Đăng nhập ngay</router-link>
        </div>
    </form>
</template>
